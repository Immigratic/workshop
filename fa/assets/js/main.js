...
var target_date = new Date("Sep 1, 2023").getTime();
...
setInterval(function () {
    ...
    days_span.innerHTML = '<span class="number">' + days + '</span>' + '<span class="unit">روز</span>';
    hours_span.innerHTML = '<span class="number">' + hours + '</span>' + '<span class="unit">ساعت</span>';
    minutes_span.innerHTML = '<span class="number">' + minutes + '</span>' + '<span class="unit">دقیقه</span>';
    secs_span.innerHTML = '<span class="number">' + seconds + '</span>' + '<span class="unit">ثانیه</span>'; 
